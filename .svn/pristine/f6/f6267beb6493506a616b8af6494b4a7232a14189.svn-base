...
import com.bochat.app.app.activity.CaptureActivity;
import com.bochat.app.model.zxing.wifi.WifiConfigManager;
...
//      parent.restartPreviewAfterDelay(0L);
  ...
  // Display the name of the network and the network type to the friendDetail.
  @Override
