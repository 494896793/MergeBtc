...
-keepclassmembers class com.bochat.example.JSInterface {
    <methods>;
}

#
#---------------------------------类---------------------------
#--------(实体Model不能混淆，否则反射找不到对应的属性获取不到值)-----
#

-keep class com.bochat.app.model.bean.CodeEntity { *; }

-keep public class * extends com.bochat.app.model.bean.CodeEntity {
    *;
}
...
-keep interface com.zhihu.** { *; }

-keep class com.belerweb.** { *; }
-keep interface com.belerweb.** { *; }
