 ...
 * Description : 钱包
 */
@Route(path = RouterWalletGY.PATH)
public class WalletActivity_GY extends BaseActivity<WalletContract.Presenter> implements WalletContract.View {
    @Inject
    ...
    private String[] titles = new String[]{"零钱","糖果"};
    ...
    protected void setRootView(Bundle savedInstanceState) {
        setContentView(R.layout.activity_mine_wallet_gy);
    }
    ...
    protected void initWidget() {
        ...
        try{
            ...
            RouterWalletGY extra = getExtra(RouterWalletGY.class);
            if(extra.isSelectToken()){
                tab.setCurrentTab(1);
            }
        }catch (Exception e){
            e.printStackTrace();
