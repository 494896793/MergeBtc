...
package com.bochat.app.model.zxing.encode;
...
import com.bochat.app.model.zxing.FinishListener;
...
public final class EncodeActivity extends Activity {
  ...
  protected void onResume() {
    ...
    try {
      ...
      if (intent.getBooleanExtra(com.bochat.app.model.zxing.share.Intents.Encode.SHOW_CONTENTS, true)) {
