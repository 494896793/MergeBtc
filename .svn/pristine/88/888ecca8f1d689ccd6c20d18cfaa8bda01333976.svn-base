...
public class GroupEntityDao extends AbstractDao<GroupEntity, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Question = new Property(13, String.class, "question", false, "QUESTION");
    };
    ...
    public GroupEntity readEntity(Cursor cursor, int offset) {
        GroupEntity entity = new GroupEntity( //
            ...
            cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13) // question
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, GroupEntity entity, int offset) {
        ...
        entity.setQuestion(cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13));
     }
