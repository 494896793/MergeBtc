package com.bochat.app.app.view.horismartrefresh;
...
import static com.bochat.app.app.view.horismartrefresh.ScrollBoundaryHorizontal.canScrollLeft;
import static com.bochat.app.app.view.horismartrefresh.ScrollBoundaryHorizontal.canScrollRight;
