...
public interface BusinessComponent {
    ...
    void inject(RedHallPresenter presenter);

    void inject(RechargePresenter presenter);

    void inject(AddressTeamPresenter presenter);

    void inject(PrivilegePresenter presenter);

    void inject(RechargeVipSuccessPresenter presenter);

    void inject(RedHallDetailPresenter presenter);
