...
/**
 * Author      : FJ
 * CreateDate  : 2019/05/16 09:28
 * Description :
 */

public class EditPayPasswordPresenter extends BasePresenter<EditPayPasswordContract.View> implements EditPayPasswordContract.Presenter {
    ...
    public void enter(final String oldPwd, final String newPwd, String pwdConfirm) {
        ...
        Disposable subscribe = Observable.create(new ObservableOnSubscribe<CodeEntity>() {
            ...
            public void subscribe(ObservableEmitter<CodeEntity> emitter) throws Exception {
                try {
                    CodeEntity entity = settingModule.updateTradePwd(oldPwd, newPwd);
    ...
    public void forgetPassword() {
        Router.navigation(new RouterGetVerifyCode(), RouterEditPayPassword.class);
    }
}
