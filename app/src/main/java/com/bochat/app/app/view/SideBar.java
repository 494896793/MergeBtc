...
//            "W", "X", "Y", "Z", "#"};
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int maxLength = ResourceUtils.dip2px(mContext, R.dimen.dp_20);
        int textSize = ResourceUtils.dip2px(mContext, R.dimen.dp_14);
        singleHeight = singleHeight > maxLength ? maxLength : singleHeight;
