...
public class SearchLocalFriendAdapter extends FuzzySearchBaseAdapter<SearchLocalFriendAdapter.LocalFriendEntity> {
    
    private Context context;
    
    public SearchLocalFriendAdapter(Context context, List<LocalFriendEntity> dataList) {
        super(null, dataList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            viewHolder.signature = convertView.findViewById(R.id.friend_signature);
        ...
        viewHolder.signature.setText(friendEntity.getSignature());    
        return convertView;
    }
