...
public class SplashScreenActivity extends BaseActivity<SplashScreenContract.Presenter> implements SplashScreenContract.View {
    ...
    RelativeLayout mSplashScreenLayout;
    
    @BindView(R.id.splash_ad_layout)
    RelativeLayout mSplashAdLayout;
    
    @BindView(R.id.splash_screen_bg)
    ImageView mSplashScreenBg;
        ...
        Observable.intervalRange(1, SPLASH_SECONDS, 0, 1, TimeUnit.SECONDS)
                ...
                .doOnNext(new Consumer<Long>() {
                    ...
                    public void accept(Long aLong) throws Exception {
                        ...
                        mSplashAdLayout.setVisibility(View.VISIBLE);
                        mSplashScreenLayout.setVisibility(View.GONE);
    ...
    public void loadAdvert(final AdvertEntity entity) {
        Log.i("=======","=============splash:"+entity.getImage());
        Glide.with(this).load(entity.getImage()).into(mSplashScreenBg);
    }
