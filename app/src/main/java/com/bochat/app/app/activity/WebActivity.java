                        ...
                        mDownloadApk = new DownloadApk.Builder()
                                ...
                                .setOnDownloadApkListener(new DownloadApk.Builder.SimpleDownloadApkListener() {
                                    ...
                                    public void onDownloadCompleted() {
                                        DownloadApk.install(getViewContext());
                                    }
                                })
                                .build();
                        mDownloadApk.startDownload();
//                        threadDownload=new MultiThreadDownload(new Handler(),url , DIRPATH + Constan.SOON_FILE_DIR, Constan.APK_NAME, getViewContext());
//                        threadDownload.start();
                        ToastUtils.s(getViewContext(),"开始下载...");
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                }
        ...
        add_friend_top_bar.setOnClickListener(new BoChatTopBar.OnClickListener() {
            ...
            public void onRightExtButtonClick() {
                ShareDialog shareDialog = new ShareDialog(getViewContext(), SHARE_TITLE, SHARE_DESCRIPTION, extra.getShareUrl());
