...
package com.bochat.app.model.zxing.result;

import android.annotation.SuppressLint;
import android.telephony.PhoneNumberUtils;

import com.bochat.app.R;
import com.bochat.app.model.zxing.Contents;
import com.bochat.app.model.zxing.Intents;
import com.bochat.app.model.zxing.LocaleManager;
import com.bochat.app.model.zxing.PreferencesActivity;
import com.bochat.app.model.zxing.book.SearchBookContentsActivity;
...
public abstract class ResultHandler {
  ...
  final void rawLaunchIntent(Intent intent) {
    if (intent != null) {
      intent.addFlags(Intents.Scan.FLAG_NEW_DOC);
  ...
  /**
   * Like {@link #rawLaunchIntent(Intent)} but will show a friendDetail dialog_offline if nothing is available to handle.
   */
