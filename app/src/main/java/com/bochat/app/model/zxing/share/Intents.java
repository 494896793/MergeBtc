package com.bochat.app.model.zxing.share;
/*
...
public final class Intents {
    ...
    public static final class Scan {
         ...
         * If the friendDetail presses Back, the result code will be {@link android.app.Activity#RESULT_CANCELED}.
         */
    ...
    public static final class Encode {
        ...
        /**
         * Normally the contents of the barcode are displayed to the friendDetail in a TextView. Setting this
    ...
    public static final class Share {
        /**
         * Give the friendDetail a choice of items to encode as a barcode, then render it as a QR Code and
